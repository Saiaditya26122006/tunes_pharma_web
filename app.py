...
products_data = {
    "ecoglim-mv1": {
        "name": "Ecoglim MV1",
        "description": "Ecoglim MV 1mg/500mg/0.2mg Tablet SR is used to control blood sugar levels in adults with type 2 diabetes. It combines Glimepiride, Metformin and Methylcobalamin for comprehensive glycemic management with nerve support.",
        "image": "ecoglim-mv1.jpg",
        "price": "₹78.57",
        "features": "Metformin + Glimepiride + Methylcobalamin",
        "benefits": "Enhances overall health and improves glycemic control in diabetic patients with nutritional nerve support.",
    ...
    "ecoglim-mv2": {
        "name": "Ecoglim-MV2",
        "description": "Ecoglim-MV2 combines Glimepiride, Metformin Hydrochloride SR and Voglibose to deliver triple-action glycemic control — stimulating insulin secretion, reducing hepatic glucose output, and blocking post-meal carbohydrate absorption.",
        "image": "ecoglim-mv2.jpg",
        "price": "₹95.00",
        "features": "Glimepiride + Metformin SR + Voglibose",
        "benefits": "Triple-action control of blood sugar: insulin secretion, hepatic glucose, and carbohydrate absorption.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Diabetic",
    ...
    "ecoglim-mp1": {
        "name": "Ecoglim-MPI",
        "description": "Ecoglim-MPI combines Metformin Hydrochloride Prolonged Release, Glimepiride and Pioglitazone for comprehensive Type 2 diabetes management targeting insulin resistance, glucose production and secretion simultaneously.",
        "image": "ecoglim-mp1.jpg",
        "price": "₹110.00",
        "features": "Metformin PR + Glimepiride + Pioglitazone",
        "benefits": "Triple-mechanism antidiabetic action — insulin sensitization, hepatic glucose reduction, and insulin secretagogue.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Diabetic",
        "composition": "Metformin Hydrochloride PR 500mg + Glimepiride 1mg + Pioglitazone 15mg",
        "indication": "Type 2 Diabetes Mellitus with Insulin Resistance",
        "schedule": "H"
    },
    "ecoglim-mp2": {
        "name": "Ecoglim MP2",
        "description": "Ecoglim MP2 combines Metformin Hydrochloride Prolonged Release, Glimepiride and Pioglitazone in a higher-strength formulation for patients requiring more aggressive glycemic control with insulin sensitization.",
        "image": "ecoglim-mp2.jpg",
        "price": "₹125.00",
        "features": "Metformin PR + Glimepiride 2mg + Pioglitazone",
        "benefits": "Enhanced triple-action antidiabetic therapy for advanced Type 2 diabetes with marked insulin resistance.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Diabetic",
    ...
    "nactaid": {
        "name": "NACTaid",
        "description": "NACTaid combines N-Acetylcysteine and Taurine to deliver powerful antioxidant, hepatoprotective and mucolytic benefits. It supports glutathione synthesis and cellular detoxification.",
        "image": "nactaid.jpg",
        "price": "₹120.00",
        "features": "N-Acetylcysteine + Taurine",
        "benefits": "Potent antioxidant action, liver protection, mucolytic support and cellular detoxification.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Metabolic",
        "composition": "N-Acetylcysteine 600mg + Taurine 500mg",
        "indication": "Oxidative Stress, Liver Support, Metabolic Wellness",
        "schedule": "H"
    },
    "resgaba-nt": {
        "name": "Resgaba-NT",
        "description": "Resgaba-NT combines Pregabalin, Nortriptyline and Mecobalamin for comprehensive neuropathic pain management. It targets pain signalling, mood pathways and nerve regeneration simultaneously.",
        "image": "resgaba-nt.jpg",
        "price": "₹150.00",
        "features": "Pregabalin + Nortriptyline + Mecobalamin",
        "benefits": "Multi-modal neuropathic pain relief with nerve regeneration support via Mecobalamin.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Ortho",
        "composition": "Pregabalin 75mg + Nortriptyline 10mg + Mecobalamin 1500mcg",
        "indication": "Diabetic Neuropathy, Fibromyalgia, Neuropathic Pain",
        "schedule": "H"
    },
    "resgaba-dlx": {
        "name": "RESGABA-DLX",
        "description": "Advanced pain management combining Pregabalin and Duloxetine for dual-action relief targeting both central and peripheral pain sensitization with mood stabilisation.",
        "image": "resgaba-dlx.jpg",
        "price": "₹180.00",
        "features": "Pregabalin + Duloxetine",
        "benefits": "Central and peripheral pain relief with antidepressant benefits for chronic pain patients.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Ortho",
        "composition": "Pregabalin 75mg + Duloxetine 30mg",
        "indication": "Chronic Neuropathic Pain, Generalized Anxiety Disorder",
        "schedule": "H"
    },
    "rabishir-dsr": {
        "name": "RABISHIR-DSR",
        "description": "Gastrointestinal dual-action therapy combining Rabeprazole DSR and Domperidone for superior acid suppression and gastric motility improvement.",
        "image": "rabishir-dsr.jpg",
        "price": "₹95.00",
        "features": "Rabeprazole + Domperidone DSR",
        "benefits": "Potent acid suppression with improved gastric emptying and reduced nausea.",
        "manufacturer": "Tunes Therapeutics Pvt. Ltd.",
        "category": "Gastro",
        "composition": "Rabeprazole 20mg + Domperidone 30mg SR",
        "indication": "GERD, Gastritis, Peptic Ulcer Disease, Acid Reflux",
        "schedule": "H"
    }
}
